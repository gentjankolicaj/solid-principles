...
class BasicCalculatorTest {
    ...
    void calculate() {
        ...
        assertThrows(IllegalStateException.class,()->calculator.calculate(ScientificOperation.EXPONENTIAL,new BasicInput(shapes)));
        assertDoesNotThrow(()->calculator.calculate(BasicOperation.AREA_ADDITION,new BasicInput(shapes)));
